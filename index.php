...
$botToken = "7124926593:AAGHjq7c768HWYPECkTrwlzRqYUyTSrY5Kc";
...
$emojid = '❌';
$emojil = '✅';
$owner = '<code>@Emon2947</code>';
$botu = "𝘽𝙊𝙏 𝙐𝙋𝘿𝘼𝙏𝙀𝙎 ↯ @Emon2947";
$bota = "<b>|×| 𝘿𝙀𝙑 ↯ @Emon2947</b>";$eror = "<b>Error ❌</b>";
...
$owner = '<code>𝓜𝓡 𝓕𝓞𝓞𝓛 𝓒𝓐𝓡𝓓𝓔𝓡</code>';
...
if ($cdata2 == "back2") {
    $gatesText = "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝗧𝗼 𝓜𝓡 𝓕𝓞𝓞𝓛 𝓒𝓗𝓔𝓒𝓚𝓔𝓡. ⚠️ Buy The Plan First.";
    ...
    $videoUrl = "https://t.me/MrFoolCarder/3";
...
• 𝙋𝘼𝙔𝙈𝙀𝙉𝙏 𝙈𝙀𝙏𝙃𝙊𝘿 •
  ...
  🔸BINANCE USER - <code>Not Available</code>
...
⚠️ 𝘛𝘏𝘐𝘚 𝘛𝘖𝘗-𝘜𝘗s 𝘈𝘙𝘌 𝘕𝘖𝘕 𝘙𝘌𝘍𝘜𝘕𝘋𝘈𝘉𝘓𝘌 ⚠️";
                                 ...
                                 $gatesKeyboard = json_encode([
                                 'inline_keyboard' => [
                                     [                     ['text' => '• 𝙑𝙀𝙍𝙄𝙁𝙔 𝙋𝘼𝙔𝙈𝙀𝙉𝙏 •', 'url' => 'https://t.me/Emon2947'],   ], ]
  ]);
...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "↯ 𝘽𝙐𝙔 𝘼𝘾𝘾𝙀𝙎𝙎", 'url' => "https://t.me/Emon2947"],
        ],
    ]
]);
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "𝙊𝙒𝙉𝙀𝙍", 'url' => "t.me/@Emon2947"], ['text' => "𝘾𝙃𝘼𝙉𝙉𝙀𝙇", 'url' => "https://t.me/MrFoolCarder"]],
        [['text' => "𝙂𝙊 𝘽𝘼𝘾𝙆 ", 'callback_data' => 'back2']]
    ]
]);
...
if ($cdata2 == "back2") {
    ...
    // Change this to your video url
    $backVideoUrl = "https://t.me/MrFoolCarder/3"; 
