...
$videoURLStart = "https://t.me/MrFoolCarder/3";


if (preg_match('/^(\/start|\.start|!start)/', $text)) {
    if (in_array($userId, $freeusers)) {
        $caption = "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 <code>@$username</code> 𝘁𝗼 𝑀𝑅 𝐹𝒪𝒪𝐿 𝒞𝐻𝐸𝒞𝒦𝐸𝑅 💖
        ...
        'inline_keyboard' => [
            [
                             ['text' => '𝙂𝘼𝙏𝙀𝙒𝘼𝙔𝙎', 'callback_data' => 'gates'],
                                 ...
                                 [
                                 ['text' => '@Emon2947', 'callback_data' => 'channel'],
                             ],
        ]
    ]);

    $caption = "Welcome To 𝓜𝓡 𝓕𝓞𝓞𝓛 𝓒𝓗𝓔𝓒𝓚𝓔𝓡. Buy The Plan First.  /price 
...

{
 ...
 $caption=" Pricing 𝓜𝓡 𝓕𝓞𝓞𝓛 𝓒𝓗𝓔𝓒𝓚𝓔𝓡 Checker📍
━━━━━━━━━━━━━━━━━━
⑄ 𝙎𝙐𝘽𝙎𝘾𝙍𝙄𝙋𝙏𝙄𝙊𝙉 𝙈𝙀𝙉𝙐 ⑄
━━━━━━━━━━━━━━━━━━
× 1 𝘞𝘌𝘌𝘒  - 3$
...
━━━━━━━━━━━━━━━━━━
 • 𝙋𝘼𝙔𝙈𝙀𝙉𝙏 𝙈𝙀𝙏𝙃𝙊𝘿 •
 🔸LTC - <code>LXCFqwktgRetQEtL9uRVTcS2va3KXsp3wU</code>
 🔸USDT (BEP20)- <code>0xf944a010ca58988a58786294dfe257badffccbb3</code>
 🔸BINANCE ID - <code>433932809</code>
━━━━━━━━━━━━━━━━━━
